...
(function() {
   ...
   */
  function init() {
    id("signup").addEventListener("submit", function(event) {
   ...
   */
  function signup() {
    let first = qs("#signup input[name = 'first-name']").value;
    let last = qs("#signup input[name = 'last-name']").value;
    let email = qs("#signup input[name = 'email']").value;
    let username = qs("#signup input[name = 'username']").value;
    let pass = qs("#signup input[name = 'password']").value;
